...
// Include database connection and header
  // Ensure header.php does not contain session_start()
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Our team ensures secure data encryption and decryption to protect your messages from unauthorized access. We use robust algorithms to safeguard sensitive information during transmission and storage. Your privacy and security are our top priorities.</p>
      </div> 
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="eshita.jpg" alt="Bonnie Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Eshita Dutta</a>
              </h3>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="dipan (2).jpg" alt="Helene Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Dipan Banerjee</a>
              </h3>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src=" sibanjan.jpg" alt="Jese Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Sibanjan Samanta</a>
              </h3>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="panda.jpg" alt="Joseph Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Debanjan Panda</a>
              </h3>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="srijani.jpg" alt="Joseph Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Srijani Ghosh</a>
              </h3>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
                      <a href="#" class="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
   ...
   <div class="right-column">
    <center>
            ...
            <a href="contact.php" class="ctn">Contact Us</a>
                 ...
                 <a href="tel:+1234567890" class="ctn">+1234567890</a>
        </div>
</section>